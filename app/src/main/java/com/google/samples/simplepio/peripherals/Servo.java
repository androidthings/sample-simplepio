package com.google.samples.simplepio.peripherals;
...
public class Servo implements Closeable {
     ...
     * Set servo rotation.
     *
     * @param angleDeg Angle in degree, between the values set in
 *                     {@link #setAngleRange(double, double)} or the defaults
     *                 {@link #DEFAULT_MIN_ANGLE_DEG} and {@link #DEFAULT_MAX_ANGLE_DEG}.
     */
